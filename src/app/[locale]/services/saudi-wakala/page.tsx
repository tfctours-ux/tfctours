// src/app/[locale]/services/saudi-wakala/page.tsx
...
export async function generateMetadata({
  ...
  return buildExtendedServiceMetadata(params, "saudi-wakala");
}
...
export default async function SaudiWakalaPage({
  ...
  const t = await getTranslations({
    locale,
    namespace: "extendedServices.saudi-wakala.page",
  });
    ...
    <article className="bg-background">
      <BreadcrumbJsonLd
        items={[
          ...
          { name: t("title"), path: localizePath(locale as Locale, "/services/saudi-wakala") },
        ]}
      />
      <PageHero
